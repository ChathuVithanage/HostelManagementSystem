        ...
        if (event.getSource() instanceof ImageView) {
            ...
            switch (icon.getId()) {
                case "imgRegistration":
                    mainPane = FXMLLoader.load(this.getClass().getResource("../MainView/manageStudentForm.fxml"));
                    break;
                case "imgRooms":
                    mainPane = FXMLLoader.load(this.getClass().getResource("../MainView/manageRoomsForm.fxml"));
                    break;
            }
